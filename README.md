...
Production-ready room configurations for the Plato Matrix — JSON schemas, Rust validator, deployment examples
...
```bash
git clone https://github.com/SuperInstance/plato-room-configs
cd plato-room-configs
```
